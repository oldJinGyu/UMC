...
public final class FragmentFirstBinding implements ViewBinding {
  ...
  private FragmentFirstBinding(@NonNull ConstraintLayout rootView, @NonNull EditText ed2,
      @NonNull TextView textView, @NonNull Button toastbutton) {
  ...
  public static FragmentFirstBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentFirstBinding((ConstraintLayout) rootView, ed2, textView, toastbutton);
    }
