...
public final class ActivitySubBinding implements ViewBinding {
  ...
  private ActivitySubBinding(@NonNull ConstraintLayout rootView, @NonNull Button btn2,
      @NonNull TextView subtext) {
  ...
  public static ActivitySubBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySubBinding((ConstraintLayout) rootView, btn2, subtext);
    }
